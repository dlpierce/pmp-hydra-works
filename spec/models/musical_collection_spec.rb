...
describe MusicalCollection do
  it_behaves_like 'An ActiveModel'
  include ActiveFedora::TestSupport
  subject { MusicalCollection.new }

  describe "when persisted to fedora" do
    before { subject.save! }
    after { subject.destroy }
    it 'should exist' do
      expect(MusicalCollection.exists?(subject.id)).to be true
    end
  end
  ...
  describe "#to_solr" do
    subject { MusicalCollection.new(title: ['War and Peace']).to_solr }
